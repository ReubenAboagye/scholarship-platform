...
export default function ContactPage() {
  ...
  const inp = "w-full px-4 py-3 rounded-lg border border-zinc-200 focus:border-brand-500 focus:ring-4 focus:ring-brand-500/5 outline-none text-sm transition-all bg-white font-light";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* ──────────────────────────────────────────────────────────────────
          ...
          ────────────────────────────────────────────────────────────────── */}
      <section className="bg-paper border-b border-zinc-200/70 pt-24 pb-16 lg:pt-32 lg:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <FadeIn>
              ...
              <h1 className="text-[40px] sm:text-[46px] lg:text-[56px] text-zinc-900 mb-6 leading-tight tracking-tight" style={SERIF}>
                We would love to <span className="italic">hear from you.</span>
              </h1>
              <p className="text-lg text-zinc-600 leading-relaxed max-w-2xl font-light">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr] gap-16 lg:gap-24 items-start">
            ...
            <div className="space-y-12">
              <FadeIn direction="right">
                <div>
                  <h2 className="text-2xl text-zinc-900 mb-8" style={SERIF}>Get in touch</h2>
                  <div className="space-y-6">
                    {contactInfo.map((c) => (
                      <div key={c.label} className="flex items-start gap-4 p-4 rounded-xl border border-zinc-100 hover:border-brand-100 hover:bg-brand-50/30 transition-all group">
                        <div className="size-10 rounded-lg bg-zinc-50 flex items-center justify-center flex-shrink-0 border border-zinc-200 group-hover:bg-white group-hover:border-brand-200 transition-colors">
                          <c.icon className="size-4 text-zinc-500 group-hover:text-brand-600 transition-colors" />
                        </div>
                        <div>
                          <p className="text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-1">{c.label}</p>
                          <p className="text-base text-zinc-800 font-medium">{c.value}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="relative group overflow-hidden rounded-2xl shadow-lg border border-zinc-200 mt-12">
                  <Image
                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-2xl p-6 mt-8 relative overflow-hidden">
                  <div className="absolute -right-4 -bottom-4 opacity-5">
                    <Sparkles className="size-24 text-zinc-950" />
                  </div>
                  <h3 className="text-zinc-900 mb-2 text-sm">Want to suggest a scholarship?</h3>
                  <p className="text-sm text-zinc-500 leading-relaxed font-light relative z-10">
            ...
            <div className="relative">
              <FadeIn delay={0.2}>
                {sent ? (
                  <div className="bg-white border border-zinc-200 rounded-2xl p-12 lg:p-20 text-center shadow-sm">
                    <div className="size-16 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center mx-auto mb-6">
                      <CheckCircle className="size-8 text-emerald-600" />
                    </div>
                    <h3 className="text-2xl text-zinc-900 mb-4" style={SERIF}>Message received.</h3>
                    <p className="text-zinc-600 font-light mb-8 max-w-sm mx-auto">
                      Thanks for reaching out. A specialist from our team will get back to you at <span className="font-medium text-zinc-900">{form.email}</span> within 24-48 hours.
                    </p>
                    <button 
                      onClick={() => {
                        setSent(false);
                  ...
                  <div className="bg-white border border-zinc-200 rounded-2xl p-8 lg:p-12 shadow-sm">
                    <h2 className="text-2xl text-zinc-900 mb-10" style={SERIF}>Send a message</h2>
                    {error && (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                          <label className="block text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Email Address</label>
                      ...
                      <div className="space-y-2">
                        <label className="block text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Subject</label>
                      ...
                      <div className="space-y-2">
                        <label className="block text-[11px] font-bold text-zinc-400 uppercase tracking-widest">Message</label>
