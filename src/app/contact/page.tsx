...
export default function ContactPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setLoading(true);
    // Simulate submission — replace with real endpoint / Resend / EmailJS
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              Have a question about ScholarMatch, a scholarship you think we should add, or a partnership enquiry? Send us a message and we&apos;ll get back to you promptly.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <img
                src="https://images.pexels.com/photos/6147444/pexels-photo-6147444.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Students collaborating with laptop"
                className="rounded-2xl w-full object-cover h-56 shadow-md"
              />

              <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100">
                <h3 className="font-bold text-slate-900 mb-2 text-sm">Want to suggest a scholarship?</h3>
                <p className="text-xs text-slate-500 leading-relaxed">
                  Know of a fully-funded opportunity we haven&apos;t listed? Send us the details and we&apos;ll review and add it to the platform.
                </p>
              </div>
            </div>
              ...
              {sent ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <select required className={inp + " cursor-pointer"}
                  ...
                  <div>
                    ...
                    <textarea required rows={6} className={inp + " resize-none"}
                      placeholder="Tell us how we can help..."
                      value={form.message} onChange={(e) => setForm({ ...form, message: e.target.value })} />
                  </div>

                  <button type="submit" disabled={loading}
                    className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-60 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 text-sm">
