  ...
  if (success) {
    return (
      <div className="w-full max-w-[400px] text-center">
        <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center bg-emerald-50 border border-emerald-200">
          <CheckCircle className="h-5 w-5 text-emerald-600" />
        </div>
        <h2 className="text-xl font-bold text-slate-900 tracking-tight">Check your email</h2>
        <p className="mt-2 text-sm text-slate-500">
          We sent a confirmation link to{" "}
          <span className="font-semibold text-slate-700">{email}</span>.
          Click it to activate your account.
        </p>
        <a href="/auth/login" className="mt-6 inline-block text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors">
          ← Back to sign in
        </a>
      </div>
    );
  ...
  return (
    <div className="w-full max-w-[400px]">
      <div className="mb-5">
        ...
        <p className="mt-0.5 text-sm text-slate-500">Free access to AI-powered scholarship matching.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-1">
          <label htmlFor="fullName" className="block text-xs font-semibold text-slate-600 uppercase tracking-wide">Full name</label>
      ...
      <p className="mt-5 text-sm text-slate-500">
        ...
        <a href={loginHref} className="font-semibold text-blue-600 hover:text-blue-700 transition-colors">Sign in</a>
      </p>
    </div>
  );
}
