          ...
          <FadeIn delay={0.1}>
            <div className="prose prose-slate max-w-none space-y-12">
              ...
              <div className="bg-amber-50/50 border border-amber-100 rounded-2xl p-8 lg:p-10 relative overflow-hidden">
                ...
                <p className="text-lg text-zinc-700 leading-relaxed font-light italic relative z-10">
              ...
              {[
                ...
                <div key={section.title} className="pt-8 border-t border-zinc-100">
                  <h2 className="text-2xl text-zinc-900 mb-6" style={SERIF}>{section.title}</h2>
                  <ul className="space-y-4">
                    {section.content.map((item, i) => (
                      <li key={i} className="flex items-start gap-4 text-zinc-600 leading-relaxed font-light">
