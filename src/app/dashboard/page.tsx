    ...
    <div className="max-w-5xl mx-auto space-y-7">
      ...
      {!profileComplete && (
        <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200">
          ...
          <a href="/dashboard/profile" className="flex-shrink-0 text-xs font-semibold text-amber-700 hover:underline whitespace-nowrap">
            Complete now →
          </a>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-px bg-slate-200">
        {statCards.map((s) => (
          <a key={s.label} href={s.href} className="bg-white p-5 hover:bg-slate-50 transition-colors group">
      ...
      <div className="bg-blue-600 p-6 text-white">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-blue-200 text-xs font-semibold uppercase tracking-wide">AI Matching</span>
        </div>
        ...
        <a href={profileComplete ? "/dashboard/match" : "/dashboard/profile"}
          className="inline-flex items-center gap-2 px-4 py-2 bg-white text-blue-700 font-semibold text-sm hover:bg-blue-50 transition-colors">
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          <a href="/scholarships" className="text-xs text-blue-600 hover:underline font-medium">View all →</a>
        </div>
