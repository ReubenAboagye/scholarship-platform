...
export default function DashboardHeader({ profile }: Props) {
  ...
  return (
    <>
      <header
        className="fixed top-0 left-0 right-0 z-50 w-full border-b border-zinc-100 glass-effect flex items-center justify-between px-5 lg:px-10 safe-top min-h-[56px]"
