        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <a href="/" className="inline-flex items-center gap-1 mb-4">
              ...
              <span className="text-lg font-black text-blue-400">Match</span>
            </a>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><a href="/scholarships?country=UK"    className="hover:text-white transition-colors">Study Destinations</a></li>
            </ul>
          </div>
        </div>
