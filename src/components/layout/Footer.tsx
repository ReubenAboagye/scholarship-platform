...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-brand-900 via-brand-800 to-brand-900 text-slate-300 border-t border-brand-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><a href="/scholarships" className="text-slate-400 hover:text-white transition-colors flex items-center gap-1 group">
                Browse scholarships
              ...
              <li><a href="/destinations" className="text-slate-400 hover:text-white transition-colors">Study destinations</a></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><a href="/contact" className="text-slate-400 hover:text-white transition-colors">Contact support</a></li>
            </ul>
          </div>
        </div>
        <div className="mt-12 pt-8 border-t border-brand-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-500">
